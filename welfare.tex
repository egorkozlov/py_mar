\begin{tabular}{cccc}
    ...
    \multicolumn{4}{c}{\textit{Life-Time utilities in $t=0$}}\\[3ex]
     -287.81 &-291.2 &-273.52 &-272.69 \\
    \cmidrule(l){1-4}
    \multicolumn{4}{c}{\textit{Welfare Losses with Unilateral Divorce}}\\[3ex]
    \multicolumn{2}{c}{\Chartgirls{1.0}}& \multicolumn{2}{c}{\Chartguys{7.147394757741996e-05}}\\[-0.15ex]
    \multicolumn{2}{c}{19819.76 \$}& \multicolumn{2}{c}{1.42 \$}\\
    \hline\hline
    \end{tabular}
