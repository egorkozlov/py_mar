...
#                                                                                    self.velocity()))
    ...
    def _calculate_position(self) -> np.ndarray:
        ...
        return new_position.astype(np.float64)#np.int32)
...
#                                                                                                             minimum_improvement))
    ...
    def still_improving(self,return_d=False) -> bool:
        """
        ...
        if not return_d:   
            ...
            return improving, np.max(improvement_deltas)

    def still_moving(self,return_d=False) -> bool:
        """
        ...
        if not return_d:
            ...
            return moving, np.max(movement_deltas)
...
class Pso(object):
    ...
    def run(self) -> Tuple[np.ndarray, float]:
        ...
        for ii in range(self._maximum_iterations):
            ...
            if not improving or not moving:
