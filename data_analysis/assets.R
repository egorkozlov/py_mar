...
famvars = data.frame(iwy=iwy,iwm=iwm,year=years,age_w=age_w,head_hrs=head_hrs,head_li=head_li,
                     ...
                     wls=wls,mls=mls,ms=ms,eduf=eduf,mort1=mort1,mort2=mort2,ch_fu=ch_fu,
                     ...
                     house=house,twh=twh,n_fu=n_fu,non_fu=non_fu,hhid=hhid)
...
#Save on disk
write.csv(data,file='C:\\Users\\Fabio\\Dropbox\\JMP\\empirical analysis\\Analysis\\assets.csv')
