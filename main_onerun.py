...
if __name__ == '__main__':
    ...
    out, mdl, res = mdl_resid(x0,return_format=['distance','model_bil','scaled residuals'],solve_uni=True,solve_bil=False,verbose=True,calibration_report=False,draw=True,graphs=graphs)
