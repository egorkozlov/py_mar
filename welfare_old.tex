\begin{tabular}{cccc}
    ...
    \multicolumn{4}{c}{\textit{Life-Time utilities in $t=0$}}\\[3ex]
     -297.45 &-300.68 &-285.16 &-286.9 \\
    \cmidrule(l){1-4}
    \multicolumn{4}{c}{\textit{Welfare Losses with Unilateral Divorce}}\\[3ex]
    \multicolumn{2}{c}{\Chartgirls{1.0}}& \multicolumn{2}{c}{\Chartguys{0.43983822042467297}}\\[-0.15ex]
    \multicolumn{2}{c}{18213.36 \$}& \multicolumn{2}{c}{8010.93 \$}\\
    \hline\hline
    \end{tabular}
