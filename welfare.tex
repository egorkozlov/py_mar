\begin{tabular}{cccc}
    ...
    \multicolumn{4}{c}{\textit{Life-Time utilities in $t=0$}}\\[3ex]
     -266.7 &-264.73 &-243.37 &-246.39 \\
    \cmidrule(l){1-4}
    \multicolumn{4}{c}{\textit{Welfare Losses with Unilateral Divorce}}\\[3ex]
    \multicolumn{2}{c}{\Chartgirls{1.0}}& \multicolumn{2}{c}{\Chartguys{0.015990493458762644}}\\[-0.15ex]
    \multicolumn{2}{c}{2902891.44 \$}& \multicolumn{2}{c}{46418.67 \$}\\
    \hline\hline
    \end{tabular}
