...
def mdl_resid(x=None,save_to=None,load_from=None,return_format=['distance'],
    ...
    dc = DivorceCosts(unilateral_divorce=True,assets_kept = 1.0,u_lost_m=0.0,u_lost_f=0.0,eq_split=1.0)
    ...
    if load_from is None:
        ...
        if not solve_transition:
            ...
            dc_before = DivorceCosts(unilateral_divorce=False,money_lost_m=0.5,money_lost_f=0.5,assets_kept = 1.0,u_lost_m=0.0,u_lost_f=0.0,eq_split=1.0)
            dc_after  = DivorceCosts(unilateral_divorce=True,money_lost_m=0.5,money_lost_f=0.5,assets_kept = 1.0,u_lost_m=0.0,u_lost_f=0.0,eq_split=1.0)
