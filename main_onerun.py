...
if __name__ == '__main__':
    ...
    out, mdl_uni,mdl_bil, res = mdl_resid(x0,return_format=['distance','model_uni','model_bil','scaled residuals'],solve_uni=True,solve_bil=True,verbose=True,calibration_report=False,draw=True,graphs=graphs)
    ...
    if graphs:
        ...
        #Actual Graphs
        mdl_uni.graph(ai,zfi,zmi,psii,ti,thi)
